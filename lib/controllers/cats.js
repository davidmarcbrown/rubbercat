...
var mongoose = require('mongoose'),
    ...
    exampleCat = require('../config/dummydata').exampleCat;
...
function updateCat ( req, res, cat ){
  ...
  if ( updates.delete && cat.createdBy !== 'Anonymous' ){
    console.log( 'Deleting cat ' + cat._id );
...
exports.exampleUpdate = function ( req, res, next ){
  res.json( { dateModified : new Date() } );
};
